...
function _cpCell(txt, opts){
  ...
  // และตัดด้วย ellipsis แทนการล้นออกนอกช่อง (max-width:0 คือเทคนิคบังคับ ellipsis ให้ทำงานใน table cell ที่ fixed width)
  const numericSafety = right ? 'overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:0;' : '';
