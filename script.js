...
async function authRequestReset() {
  ...
  if (typeof firebase !== 'undefined' && firebase.apps && firebase.apps.length) {
    try {
      ...
      // else: ตกไปลอง GAS/Local ด้านล่าง
    }
  }
